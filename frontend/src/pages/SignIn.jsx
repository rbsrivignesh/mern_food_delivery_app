    ...
    return (
        <div className='min-h-screen flex items-center justify-center p-4 w-full' style={{ backgroundColor: bgColor }} >
            ...
            >
                ...
                <p className='text-gray-600 mb-8'>Sign In your account to get started with delicious food</p>
                ...
                <div onClick={() => navigate("/forgot-password")} className='text-right mb-4 text-[#ff4d2d] cursor-pointer'>Forgot Password</div>
                ...
                <button onClick={handleSignIn} className={`w-full font-semibold rounded-lg py-2 transition duration-200 bg-[#ff4d2d] text-white hover:bg-[#e64323] cursor-pointer `} > {
                    loading ? <ClipLoader color='white' size={20} /> : "Sign In"}</button>
                {error &&
                ...
                <button onClick={handleGoogleAuth} className=' cursor-pointer w-full mt-4 flex items-center justify-center gap-2 border rounded-lg px-4 py-2  transition duration-200 border-gray-400 hover:bg-gray-200'><FcGoogle size={20} /><span>Sign In With Google</span></button>
                <p onClick={() => navigate("/signup")} className='text-center cursor-pointer mt-2'>Want to create a new Account ?
